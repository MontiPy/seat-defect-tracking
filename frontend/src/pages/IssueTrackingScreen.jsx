    ...
    <Box sx={theme.layout.pageContainer}>
      ...
      <Box sx={{ flexGrow: 1, minHeight: 0, overflowY: 'auto' }}>
                  ...
                  <TableRow>
                    ...
                    <TableCell sx={{ width: 50 }}>
                      <Checkbox
                        ...
                        onChange={(e) =>
                          handleSelectAllIssues(e.target.checked)
                        }
                      />
                    </TableCell>
            ...
            {selectedIssue && (
              <Box>
                ...
                <Typography variant="h6" sx={{ mt: 3, mb: 2 }}>
                  Comments{' '}
                  {typeof selectedIssue.comments === 'string'
                    ? selectedIssue.comments.trim()
                      ? '(1)'
                      : '(0)'
        ...
        >
          ...
          <DialogActions>
            <Button onClick={() => setShowLinkDefectDialog(false)}>
              Cancel
            </Button>
            <Button
